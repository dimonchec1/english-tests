    ...
    return (
        <div className="flex items-center mt-6 text-center border rounded-lg h-96">
            <div className="flex flex-col w-full max-w-sm px-4 mx-auto">
                ...
                <h1 className="mt-3 text-lg text-gray-800  ">Организации не найдены</h1>
                <p className="mt-2 text-gray-500  ">Your search “Stripe” did not match any vendors. Please try again or create add a new vendor.</p>
