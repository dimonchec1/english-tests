...
//                                                 </div>
//                                                 <div>
//                                                     <h2 className="font-normal text-gray-800   ">Dashboard screenshot.jpg</h2>
//                                                     <p className="text-xs font-normal text-gray-500  ">720 KB</p>
//                                                 </div>
//                                             </div>
//                                         </div>
//                                     </td>
...
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Jan 4, 2022</td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Jan 4, 2022</td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Demi Wilkinson</td>
//                                     <td className="px-4 py-4 text-sm whitespace-nowrap">
//                                         <button className="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg   hover:bg-gray-100">
//                                             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
//                                                 <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
...
//                                                 </div>
//                                                 <div>
//                                                     <h2 className="font-normal text-gray-800   ">Dashboard prototype FINAL.gif</h2>
//                                                     <p className="text-xs font-normal text-gray-500  ">21 KB</p>
//                                                 </div>
//                                             </div>
//                                         </div>
//                                     </td>
...
//                                         21 KB
//                                     </td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Jan 2, 2022</td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Jan 2, 2022</td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Lana Steiner</td>
//                                     <td className="px-4 py-4 text-sm whitespace-nowrap">
//                                         <button className="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg   hover:bg-gray-100">
...
//                                                 </div>
//                                                 <div>
//                                                     <h2 className="font-normal text-gray-800   ">App inspiration.png</h2>
//                                                     <p className="text-xs font-normal text-gray-500  ">2 MB</p>
//                                                 </div>
//                                             </div>
//                                         </div>
//                                     </td>
...
//                                         2 MB
//                                     </td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Jan 8, 2022</td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Jan 8, 2022</td>
//                                     <td className="px-4 py-4 text-sm text-gray-500   whitespace-nowrap">Demi Wilkinson</td>
//                                     <td className="px-4 py-4 text-sm whitespace-nowrap">
//                                         <button className="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg   hover:bg-gray-100">
...
//                                                 </div>
//                                                 <div>
//                                                     <h2 className="font-normal text-gray-800   ">The Absolute Basics.mp4</h2>
//                                                     <p className="text-xs font-normal text-gray-500  ">720 MB</p>
//                                                 </div>
//                                             </div>
//                                         </div>
//                                     </td>
